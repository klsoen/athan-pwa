...
export const darkThemes = {
  ...
  starlight: {
    ...
    bg: '#0e0e10',
    bgGradient: 'radial-gradient(ellipse at 50% 40%, rgba(255, 190, 200, 0.12) 0%, rgba(240, 180, 190, 0.06) 40%, transparent 70%), radial-gradient(ellipse at 30% 80%, rgba(255, 200, 210, 0.08) 0%, transparent 50%)',
    accent: '#e8b088',
    accentBright: '#ffc8a8',
    accentDim: '#c89878',
    accentRgb: '232, 176, 136',
    accentBrightRgb: '255, 200, 168',
    marker: '#d8c8d0',
    text: '#ffffff',
    textMuted: '#b0a0a8',
    textRgb: '255, 255, 255',
